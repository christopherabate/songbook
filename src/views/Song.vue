          ...
          >
            <ion-content>
              <ion-list>
                <ion-item-group>
                  <ion-item>
                    <ion-label><strong>{{ song?.title }}</strong></ion-label>
                ...
                <ion-item-group>
                  ...
                  <ion-item lines="none" button detail="false" @click="openForm('song', song)">
                    <font-awesome-icon slot="end" fixed-width :icon="['fas', 'pen']" />
                    Edit
                  </ion-item>
                  <ion-item lines="none" button detail="false" @click="data.remove('song', song?.id)">
...
// Current song
const song = computed(() => {
  return songs?.value.find(song => song.id === route.params.id) || {};
});
